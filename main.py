    ...
    def handle(self, user_input):
        ...
        if lower in ("help", "h", "?"):
            return (
                ...
                "- show profile\n"
                "Notes:\n"
                "- Profile auto-saves after every change.\n"
                "- Profile auto-loads when the assistant starts."
            )
        ...
        if lower.startswith("clear "):
            ...
            if key not in self._prefs:
                return "Unknown preference field: " + key
            self._prefs[key] = ""
            self._save_prefs()
            return "Cleared: " + key
...
if __name__ == "__main__":
    ...
    print("Profile Assistant ready. Profile auto-loads on startup and auto-saves on change.")
    while True:
        user = input("> ")
